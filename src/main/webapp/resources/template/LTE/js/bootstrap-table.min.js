...
!function (a) {
    ...
    h.DEFAULTS = {
        ...
        for (var j = this.pageFrom - 1; j < this.pageTo; j++) {
            var k = i[j], l = {}, m = [], n = {}, o = [];
            if (l = f(this.options, this.options.rowStyle, [k, j], l), l && l.css)for (var p in l.css)m.push(p + ": " + l.css[p]);
            if (n = f(this.options, this.options.rowAttributes, [k, j], n))for (var p in n)o.push(b('%s="%s"', p, g(n[p])));
            h.push("<tr", b(" %s", o.join(" ")), b(' id="%s"', a.isArray(k) ? void 0 : k._id), b(' class="%s"', l.classes || (a.isArray(k) ? void 0 : k._class)), b(' data-index="%s"', j), ">"), this.options.cardView && h.push(b('<td colspan="%s">', this.header.fields.length)), a.each(this.header.fields, function (a, d) {
                ...
                } else i = "undefined" == typeof i || null === i ? e.options.undefinedText : i, g = e.options.cardView ? ['<div class="card-view">', e.options.showHeader ? b('<span class="title" %s>%s</span>', l, c(e.options.columns, "field", "title", d)) : "", b('<span class="value">%s</span>', i), "</div>"].join("") : [b("<td%s %s %s>", p, q, l), i, "</td>"].join(""), e.options.cardView && e.options.smartDisplay && "" === i && (g = "");
                h.push(g)
        ...
        h.length || h.push('<tr class="no-records-found">', b('<td colspan="%s">%s</td>', this.header.fields.length, this.options.formatNoMatches()), "</tr>"), this.$body.html(h.join("")), d || this.scrollTo(0), this.$body.find("> tr > td").off("click").on("click", function () {
            ...
            if (c) {
                ...
                for (var d in c)e.$body.find("tr").each(function () {
        ...
        if (b.hasOwnProperty("field") && b.hasOwnProperty("values")) {
            for (c = e - 1; c >= 0; c--) {
                if (d = this.options.data[c], !d.hasOwnProperty(b.field))return;
