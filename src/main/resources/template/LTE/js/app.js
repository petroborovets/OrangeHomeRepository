...
//Make sure jQuery has been loaded before app.template.LTE.js
...
$.AdminLTE.options = {
  ...
  //in every page before app.template.LTE.js
  ...
  //Bootstrap.template.LTE.js tooltip
  enableBSToppltip: true,
  BSTooltipSelector: "[data-toggle='tooltip']",
  //Enable Fast Click. Fastclick.template.LTE.js creates a more
  //native touch experience with touch devices. If you
  //choose to enable the plugin, make sure you load the script
  //before AdminLTE's app.template.LTE.js
  ...
  //The standard screen sizes that template.bootstrap uses.
...
(function ($) {
  ...
  $.fn.boxRefresh = function (options) {
    ...
    function start(box) {
      //Add overlay and loading template.LTE.img
      box.append(overlay);
    ...
    function done(box) {
      //Remove overlay and loading template.LTE.img
